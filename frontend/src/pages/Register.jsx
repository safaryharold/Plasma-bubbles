      ...
      <div className="flex items-center justify-center px-6 md:px-12 py-16 bg-[#090A0C]">
        <div className="w-full max-w-md">
          ...
          <p className="mono text-xs text-[#8B93A5] mb-10">
            Already have one? <Link className="text-white underline underline-offset-4" to="/login" data-testid="switch-to-login">Sign in instead.</Link>
          </p>
          <form onSubmit={submit} className="space-y-5">
            ...
            <Field label="Tier">
              <select value={form.role} onChange={(e) => setForm({ ...form, role: e.target.value })}
                ...
                <option value="pro">Pro (billing design hooks only)</option>
              </select>
            </Field>
